...
export default async function Home() {
	...
	const canPurchase = !user || (user?.role !== 'DOCTOR' && user?.role !== 'ADMIN');
						...
						<div className='order-2 lg:order-1 space-y-8'>
							...
							<div className='flex flex-col sm:flex-row gap-4'>
								...
								<Button
									...
									variant='outline'
									size='lg'
									className='border-emerald-700/30 hover:bg-muted/80 cursor-pointer'>
									<PrefetchLink href='/doctors'>Find Doctors</PrefetchLink>
								</Button>
							</div>
						</div>
			...
			<section
				...
				<div className='container mx-auto px-4'>
					...
					<div className='mx-auto'>
						{/* Clerk Pricing Table */}
						<Pricing canPurchase={canPurchase} />
								...
								<div className='flex flex-col sm:flex-row gap-4'>
									{showSignup && (
										<Button
											...
											size='lg'
											className='bg-emerald-600 text-white hover:bg-emerald-700'>
											<PrefetchLink href='/sign-up'>Sign Up Now</PrefetchLink>
										</Button>
									)}
									<Button
										asChild
										...
										<PrefetchLink href='#pricing'>View Pricing</PrefetchLink>
									</Button>
								</div>
							</div>
